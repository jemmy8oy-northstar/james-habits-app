...
namespace Balenthiran.Habits.WebApi.ExceptionHandling;

/// <summary>
/// The single global exception handler (issue #7). It catches everything that escapes a
/// route, maps it to an RFC 7807 <c>ProblemDetails</c> response via <see cref="ExceptionResult"/>,
/// and logs it. This removes the need for any per-route try/catch: services throw the correct
