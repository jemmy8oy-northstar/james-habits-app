...
│   ├── Balenthiran.Habits.WebApi/       # Entry point: routes, DI, OpenAPI
│   ├── Balenthiran.Habits.Services/     # Business logic, AutoMapper profiles
│   ├── Balenthiran.Habits.Abstractions/ # Service interfaces + model interfaces
│   ├── Balenthiran.Habits.Database/     # EF Core DbContext + migrations
│   ├── Balenthiran.Habits.EntityModels/ # Database entities (anemic POCOs)
│   ├── Balenthiran.Habits.DomainModels/ # Rich business-layer objects
│   └── Balenthiran.Habits.DataModels/   # Request/Response DTOs
...
```bash
# Backend (Terminal 1)
cd backend && dotnet run --project Balenthiran.Habits.WebApi
...
cd backend && dotnet ef database update \
  --project Balenthiran.Habits.Database \
  --startup-project Balenthiran.Habits.WebApi
```
...
- [ ] No concrete types defined in `Balenthiran.Habits.Abstractions`
- [ ] Service interface methods return **interfaces**, not concrete types (`IRatio`, not `Ratio`)
- [ ] `Balenthiran.Habits.Abstractions.csproj` has **zero** `<ProjectReference>` entries to concrete projects
...
- [ ] Domain models in `Balenthiran.Habits.DomainModels`, data models in `Balenthiran.Habits.DataModels`
